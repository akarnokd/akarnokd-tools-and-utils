 ...
 */
public interface AggregatorMap5<K1, K2, K3, K4, K5, V> 
extends AggregatorMap4<K1, K2, K3, K4, AggregatorMap1<K5, V>> {
	/**
	 ...
	 * @return the value
	 */
	V getValue(Object key1, Object key2, Object key3, Object key4, Object key5, V defaultValue);
	/**
	 ...
	 */
	Iterable<Value4<K1, K2, K3, K4, K5>> keys12345();
	/**
