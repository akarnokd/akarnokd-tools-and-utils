 ...
 */
public class Value4<K1, K2, K3, K4, V> {
	 ...
	 */
	public Value4(K1 key1, K2 key2, K3 key3, K4 key4, V value) {
		this.key1 = key1;
		this.key2 = key2;
		this.key3 = key3;
		this.key4 = key4;
	 ...
	 * @param value the value
	 */
	public Value4(K1 key1, Value3<K2, K3, K4, V> value) {
		this.key1 = key1;
		this.key2 = value.key1;
		this.key3 = value.key2;
		this.key4 = value.key3;
